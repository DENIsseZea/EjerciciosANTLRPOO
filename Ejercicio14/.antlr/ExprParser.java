// Generated from c:/Users/EV/Documentos/isc/LyA II/semana 2/EjerciciosANTLRPOO/Ejercicio14/Expr.g4 by ANTLR 4.13.1
...
public class ExprParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FROM'", "'WHERE'", "'SERIAL'", "'VARCHAR'", "'INTEGER'", "'DATE'", 
			"'NOT'", "'NULL'", "'PRIMARY'", "'KEY'", "'INNER'", "'JOIN'", "'ON'", 
			"'='", "'('", "')'", "';'", "','", "'.'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WHERE", "SERIAL", "VARCHAR", "INTEGER", "DATE", "NOT", "NULL", "PRIMARY", 
			"KEY", "INNER", "JOIN", "ON", "IGUAL", "PAR_A", "PAR_C", "SEMIC", "COMA", 
			"PUNTO", "STRING", "NUM", "ID", "WS"
		};
	}
